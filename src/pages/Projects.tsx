...
const projects = [
  {
    ...
    url: 'https://kyro-rhythm.vercel.app',
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
        {projects.map((project, i) => (
          <motion.div
            ...
            className="glass-panel p-8 group hover:-translate-y-2 transition-transform duration-500 relative overflow-hidden"
          >
            ...
            <p className="text-text-main/70 mb-8 leading-relaxed font-light">{project.description}</p>
            
            {project.internal ? (
              <a href={project.url} className="inline-flex items-center gap-2 text-accent font-medium hover:text-white transition-colors">
                View Project <ExternalLink className="w-4 h-4" />
              </a>
            ) : (
              <a href={project.url} target="_blank" rel="noreferrer" className="inline-flex items-center gap-2 text-accent font-medium hover:text-white transition-colors">
